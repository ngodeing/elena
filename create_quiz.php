...
<body>
  <div class="container">
    <center>
      ...
      <form action="create_quiz.php" method="post" name="form1">
        <table width="50%" border="0">
        <tr>
            <td>ID quiz</td>
            <td><input type="text" name="id_quiz" maxlength="11" required></td>
          </tr>
          <tr>
            <td>Nama quiz</td>
            <td><input type="text" name="nama_quiz" required></td>
          </tr>
          <tr>
            <td>Deadline</td>
      ...
      if (isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($conn, "INSERT INTO quiz(id_quiz,nama_quiz,deadline, kode_mk) VALUES('$id_quiz','$nama', '$deadline', '$kode_mk')");

        // Show message when user added
        echo "Data berhasil ditambahkan  <a class='btn btn-primary' href='quiz.php'>Lihat Data</a>";
      }
      ?>
      <br>
